...
const ICONS = {
    ...
    inbox:        'tabler:inbox',
    blacklist:    'tabler:ban',
    departments:  'tabler:building',
};
...
const NAV_SECTIONS = [
    ...
    },
    {
        ...
        items: [
            ...
            { path: '/departments',           icon: ICONS.departments, label: 'Departments',   roles: ['admin'] },
            ...
            { path: '/guests/blacklist',      icon: ICONS.blacklist,   label: 'Blacklist',     roles: ['admin'] },
    ...
    },
    {
        title: 'Notifications',
        items: [
            { path: '/notifications',          icon: ICONS.inbox,     label: 'Inbox',          roles: ['admin', 'operator'] },
            { path: '/notification-templates', icon: ICONS.templates, label: 'Templates',      roles: ['admin'] },
        ],
    },
    {
        title: 'Router',
